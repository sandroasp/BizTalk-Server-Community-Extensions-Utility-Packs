...
namespace BizTalk.String.Functoids
{
    ...
    public class Replace : BaseFunctoid
    {
        ...
        private string GetCSharpBuffer()
        {
            ...
            builder.Append("{\n");
            builder.Append("\tif(oldValue == \"\\\\r\")\n");
            builder.Append("\t\treturn element.Replace(\"\\r\", newValue);\n");
            builder.Append("\tif (oldValue == \"\\\\n\")\n");
            builder.Append("\t\treturn element.Replace(\"\\n\", newValue);\n");
            builder.Append("\tif (oldValue == \"\\\\n\\\\r\")\n");
            builder.Append("\t\treturn element.Replace(\"\\n\\r\", newValue);\n");
        ...
        {
            if(oldValue == "\\r")
                return element.Replace("\r", newValue);
            if (oldValue == "\\n")
