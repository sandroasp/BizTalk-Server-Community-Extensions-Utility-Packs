...
{
    [Serializable]
    public class MsCrmMapHelperBaseTypes : BaseFunctoid
    {
        public MsCrmMapHelperBaseTypes()
            : base()
        {
            ...
            SetName("FUNCTOID_NAME_BASETYPE");
            SetTooltip("FUNCTOID_TOOLTIP_BASETYPE");
            SetDescription("FUNCTOID_DESCRIPTION_BASETYPE");
            SetBitmap("FUNCTOID_BITMAP_BASETYPE");
        ...
        private string DefineTemplate()
        {
            ...
            returnValue.AppendLine(@"<xsl:template name=""MsCrmMapHelperBaseType"">");
            ...
            returnValue.AppendLine(@"<value xmlns=""http://schemas.datacontract.org/2004/07/System.Collections.Generic"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"" xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"">");
            returnValue.AppendLine(@"<xsl:attribute name=""xsi:type"">");
            returnValue.AppendLine(@"<xsl:value-of select=""$param3"" />");
